...
xcopy /d /c /e /i /y "%input_folder%source\src_data\tools" "%build_folder%\data\tools" > nul 2>&1
xcopy /d /y "%input_folder%source\src_data\settings\SplashScreen.jpg" "%build_folder%\data\settings\" > nul 2>&1
